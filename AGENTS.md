...
| `sdks/dart/` | `lantern_client` (Dart package) | Pure-Dart Android/iOS-first client SDK. Generated directly from `proto/`; outside `go.work`. |
...
(cd sdks/dart && dart pub get && dart analyze && dart test)
