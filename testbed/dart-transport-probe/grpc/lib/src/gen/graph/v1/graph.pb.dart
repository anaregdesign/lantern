...
class SearchVerticesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<SearchProjection>(6, _omitFieldNames ? '' : 'projection',
...
class SearchVerticesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'nextCursor', $pb.PbFieldType.OY)
    ..aI(3, _omitFieldNames ? '' : 'effectiveLimit',
        fieldType: $pb.PbFieldType.OU3)
...
class SearchHit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<SearchHitProjectionStatus>(
        4, _omitFieldNames ? '' : 'projectionStatus',
...
class SearchErrorDetail extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SearchErrorDetail clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class SearchCapabilities extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aI(3, _omitFieldNames ? '' : 'defaultLimit',
        fieldType: $pb.PbFieldType.OU3)
    ..aI(4, _omitFieldNames ? '' : 'maxLimit', fieldType: $pb.PbFieldType.OU3)
    ..aE<MatchMode>(5, _omitFieldNames ? '' : 'defaultMatchMode',
        enumValues: MatchMode.values)
    ..aI(6, _omitFieldNames ? '' : 'defaultMinShouldMatch',
        fieldType: $pb.PbFieldType.OU3)
    ..aI(7, _omitFieldNames ? '' : 'maxFuzziness',
        fieldType: $pb.PbFieldType.OU3)
    ...
    ..aI(17, _omitFieldNames ? '' : 'maxInFlight',
        fieldType: $pb.PbFieldType.OU3)
    ..aI(18, _omitFieldNames ? '' : 'maxDocumentBytes',
        fieldType: $pb.PbFieldType.OU3)
    ..aI(19, _omitFieldNames ? '' : 'maxDocumentTokens',
        fieldType: $pb.PbFieldType.OU3)
    ..aI(20, _omitFieldNames ? '' : 'maxDocumentTerms',
        fieldType: $pb.PbFieldType.OU3)
    ..a<$fixnum.Int64>(
    ...
    ..a<$fixnum.Int64>(
        ...
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aD(24, _omitFieldNames ? '' : 'compactionRatio')
    ..a<$fixnum.Int64>(
    ...
    ..a<$fixnum.Int64>(
        ...
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aI(28, _omitFieldNames ? '' : 'cursorTtlSeconds',
        fieldType: $pb.PbFieldType.OU3)
    ..aI(29, _omitFieldNames ? '' : 'maxSessions',
        fieldType: $pb.PbFieldType.OU3)
    ..aI(30, _omitFieldNames ? '' : 'maxSessionHits',
        fieldType: $pb.PbFieldType.OU3)
    ..a<$fixnum.Int64>(
...
class SearchIndexStats extends $pb.GeneratedMessage {
  factory SearchIndexStats({
    ...
    $2.Duration? lastRebuildDuration,
    ...
    $2.Duration? lastExpirationPurgeDuration,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'graph.v1'),
      createEmptyInstance: create)
    ..aE<SearchIndexHealth>(1, _omitFieldNames ? '' : 'health',
    ...
    ..a<$fixnum.Int64>(
        ...
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$2.Duration>(11, _omitFieldNames ? '' : 'lastRebuildDuration',
        subBuilder: $2.Duration.create)
    ..a<$fixnum.Int64>(
    ...
    ..a<$fixnum.Int64>(
        ...
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$2.Duration>(16, _omitFieldNames ? '' : 'lastExpirationPurgeDuration',
        subBuilder: $2.Duration.create)
    ..a<$fixnum.Int64>(
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SearchIndexStats clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(11)
  $2.Duration get lastRebuildDuration => $_getN(10);
  @$pb.TagNumber(11)
  set lastRebuildDuration($2.Duration value) => $_setField(11, value);
  @$pb.TagNumber(11)
  $core.bool hasLastRebuildDuration() => $_has(10);
  @$pb.TagNumber(11)
  void clearLastRebuildDuration() => $_clearField(11);
  @$pb.TagNumber(11)
  $2.Duration ensureLastRebuildDuration() => $_ensure(10);
  ...
  @$pb.TagNumber(16)
  $2.Duration get lastExpirationPurgeDuration => $_getN(15);
  @$pb.TagNumber(16)
  set lastExpirationPurgeDuration($2.Duration value) => $_setField(16, value);
  @$pb.TagNumber(16)
  $core.bool hasLastExpirationPurgeDuration() => $_has(15);
  @$pb.TagNumber(16)
  void clearLastExpirationPurgeDuration() => $_clearField(16);
  @$pb.TagNumber(16)
  $2.Duration ensureLastExpirationPurgeDuration() => $_ensure(15);
...
class ReceiptEndpoint extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReceiptEndpoint clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class MutationReceiptContext extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MutationReceiptContext clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class GetReceiptCapabilityRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetReceiptCapabilityRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class GetReceiptCapabilityResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetReceiptCapabilityResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ReceiptStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        1, _omitFieldNames ? '' : 'operationId', $pb.PbFieldType.OY)
    ..aE<MutationReceiptState>(2, _omitFieldNames ? '' : 'state',
...
class GetReceiptStatusRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetReceiptStatusRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class GetReceiptStatusResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetReceiptStatusResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class GetReceiptStatusesRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetReceiptStatusesRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class GetReceiptStatusesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'graph.v1'),
      createEmptyInstance: create)
    ..pPM<ReceiptStatus>(1, _omitFieldNames ? '' : 'statuses',
        subBuilder: ReceiptStatus.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetReceiptStatusesResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
