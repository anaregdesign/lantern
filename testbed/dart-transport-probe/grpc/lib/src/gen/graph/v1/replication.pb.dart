...
class ReplicatedReceiptEdgeDeleteItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'graph.v1'),
      createEmptyInstance: create)
    ..aOM<$1.EdgeKey>(1, _omitFieldNames ? '' : 'key',
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptEdgeDeleteItem clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $1.EdgeKey get key => $_getN(0);
  @$pb.TagNumber(1)
  set key($1.EdgeKey value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasKey() => $_has(0);
  @$pb.TagNumber(1)
  void clearKey() => $_clearField(1);
  @$pb.TagNumber(1)
  $1.EdgeKey ensureKey() => $_ensure(0);
...
class ReplicatedReceiptEdgeDelete extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<ReplicatedReceiptEdgeDeleteItem>(4, _omitFieldNames ? '' : 'items',
        subBuilder: ReplicatedReceiptEdgeDeleteItem.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptEdgeDelete clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ReplicatedReceiptEdgeAddItem extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptEdgeAddItem clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ReplicatedReceiptEdgeAdd extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'policyFingerprint', $pb.PbFieldType.OY)
    ..pPM<ReplicatedReceiptEdgeAddItem>(3, _omitFieldNames ? '' : 'items',
        subBuilder: ReplicatedReceiptEdgeAddItem.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptEdgeAdd clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class SnapshotReceiptMetadata extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SnapshotReceiptMetadata clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class SnapshotHeader extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$fixnum.Int64>(
        ...
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aE<SnapshotFormat>(4, _omitFieldNames ? '' : 'format',
        enumValues: SnapshotFormat.values)
...
class SnapshotReceiptContribution extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SnapshotReceiptContribution clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class SnapshotReceipt extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aI(3, _omitFieldNames ? '' : 'itemIndex', fieldType: $pb.PbFieldType.OU3)
    ..aI(4, _omitFieldNames ? '' : 'itemCount', fieldType: $pb.PbFieldType.OU3)
    ..aE<SnapshotReceiptKind>(5, _omitFieldNames ? '' : 'kind',
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SnapshotReceipt clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class SnapshotEdgeDerivedAggregate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.Timestamp>(2, _omitFieldNames ? '' : 'expiration',
        subBuilder: $2.Timestamp.create)
    ..pPM<SnapshotEdgeContribution>(3, _omitFieldNames ? '' : 'adds',
        subBuilder: SnapshotEdgeContribution.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SnapshotEdgeDerivedAggregate clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
