...
class MutationOp extends $pb.GeneratedMessage {
  ...
  /// accepted projection.
  @$pb.TagNumber(18)
  ReplicatedReceiptEdgeAdd get replicatedReceiptEdgeAdd => $_getN(17);
  @$pb.TagNumber(18)
  set replicatedReceiptEdgeAdd(ReplicatedReceiptEdgeAdd value) =>
      $_setField(18, value);
  @$pb.TagNumber(18)
  $core.bool hasReplicatedReceiptEdgeAdd() => $_has(17);
  @$pb.TagNumber(18)
...
class ReplicatedReceiptVertexPutItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'graph.v1'),
      createEmptyInstance: create)
    ..aOM<$0.Vertex>(1, _omitFieldNames ? '' : 'original',
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptVertexPutItem clone() =>
      ReplicatedReceiptVertexPutItem()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ReplicatedReceiptVertexPutItem> createRepeated() =>
      $pb.PbList<ReplicatedReceiptVertexPutItem>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $0.Vertex get original => $_getN(0);
  @$pb.TagNumber(1)
  set original($0.Vertex value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasOriginal() => $_has(0);
  @$pb.TagNumber(1)
  void clearOriginal() => $_clearField(1);
  @$pb.TagNumber(1)
  $0.Vertex ensureOriginal() => $_ensure(0);
...
class ReplicatedReceiptVertexPut extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<ReplicatedReceiptVertexPutItem>(
        4, _omitFieldNames ? '' : 'items', $pb.PbFieldType.PM,
        subBuilder: ReplicatedReceiptVertexPutItem.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptVertexPut clone() =>
      ReplicatedReceiptVertexPut()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ReplicatedReceiptVertexPut> createRepeated() =>
      $pb.PbList<ReplicatedReceiptVertexPut>();
  @$core.pragma('dart2js:noInline')
...
class ReplicatedReceiptVertexDeleteItem extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptVertexDeleteItem clone() =>
      ReplicatedReceiptVertexDeleteItem()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ReplicatedReceiptVertexDeleteItem> createRepeated() =>
      $pb.PbList<ReplicatedReceiptVertexDeleteItem>();
  @$core.pragma('dart2js:noInline')
...
class ReplicatedReceiptVertexDelete extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.Timestamp>(3, _omitFieldNames ? '' : 'tombstoneExpiration',
        subBuilder: $1.Timestamp.create)
    ..pc<ReplicatedReceiptVertexDeleteItem>(
        4, _omitFieldNames ? '' : 'items', $pb.PbFieldType.PM,
        subBuilder: ReplicatedReceiptVertexDeleteItem.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptVertexDelete clone() =>
      ReplicatedReceiptVertexDelete()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ReplicatedReceiptVertexDelete> createRepeated() =>
      $pb.PbList<ReplicatedReceiptVertexDelete>();
  @$core.pragma('dart2js:noInline')
...
class ReplicatedReceiptEdgeAddItem extends $pb.GeneratedMessage {
  factory ReplicatedReceiptEdgeAddItem({
    $0.Edge? original,
  ...
  ReplicatedReceiptEdgeAddItem._();

  factory ReplicatedReceiptEdgeAddItem.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ReplicatedReceiptEdgeAddItem.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ReplicatedReceiptEdgeAddItem',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'graph.v1'),
      createEmptyInstance: create)
    ...
    ..aOM<$0.MutationReceipt>(3, _omitFieldNames ? '' : 'receipt',
        subBuilder: $0.MutationReceipt.create)
    ..aOB(4, _omitFieldNames ? '' : 'causallyAccepted')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptEdgeAddItem clone() =>
      ReplicatedReceiptEdgeAddItem()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptEdgeAddItem copyWith(
          void Function(ReplicatedReceiptEdgeAddItem) updates) =>
      super.copyWith(
              (message) => updates(message as ReplicatedReceiptEdgeAddItem))
          as ReplicatedReceiptEdgeAddItem;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ReplicatedReceiptEdgeAddItem create() =>
      ReplicatedReceiptEdgeAddItem._();
  @$core.override
  ReplicatedReceiptEdgeAddItem createEmptyInstance() => create();
  static $pb.PbList<ReplicatedReceiptEdgeAddItem> createRepeated() =>
      $pb.PbList<ReplicatedReceiptEdgeAddItem>();
  @$core.pragma('dart2js:noInline')
  static ReplicatedReceiptEdgeAddItem getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ReplicatedReceiptEdgeAddItem>(create);
  static ReplicatedReceiptEdgeAddItem? _defaultInstance;
  ...
  @$pb.TagNumber(4)
  $core.bool get causallyAccepted => $_getBF(3);
  @$pb.TagNumber(4)
  set causallyAccepted($core.bool value) => $_setBool(3, value);
  @$pb.TagNumber(4)
  $core.bool hasCausallyAccepted() => $_has(3);
  @$pb.TagNumber(4)
  void clearCausallyAccepted() => $_clearField(4);
}
...
class ReplicatedReceiptEdgeAdd extends $pb.GeneratedMessage {
  factory ReplicatedReceiptEdgeAdd({
    $core.List<$core.int>? deploymentEpoch,
    $core.List<$core.int>? policyFingerprint,
    $core.Iterable<ReplicatedReceiptEdgeAddItem>? items,
  }) {
    final result = create();
    if (deploymentEpoch != null) result.deploymentEpoch = deploymentEpoch;
    if (policyFingerprint != null) result.policyFingerprint = policyFingerprint;
  ...
  ReplicatedReceiptEdgeAdd._();

  factory ReplicatedReceiptEdgeAdd.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ReplicatedReceiptEdgeAdd.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ReplicatedReceiptEdgeAdd',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'graph.v1'),
      createEmptyInstance: create)
    ..a<$core.List<$core.int>>(
        1, _omitFieldNames ? '' : 'deploymentEpoch', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'policyFingerprint', $pb.PbFieldType.OY)
    ..pc<ReplicatedReceiptEdgeAddItem>(
        3, _omitFieldNames ? '' : 'items', $pb.PbFieldType.PM,
        subBuilder: ReplicatedReceiptEdgeAddItem.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptEdgeAdd clone() =>
      ReplicatedReceiptEdgeAdd()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedReceiptEdgeAdd copyWith(
          void Function(ReplicatedReceiptEdgeAdd) updates) =>
      super.copyWith((message) => updates(message as ReplicatedReceiptEdgeAdd))
          as ReplicatedReceiptEdgeAdd;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ReplicatedReceiptEdgeAdd create() => ReplicatedReceiptEdgeAdd._();
  @$core.override
  ReplicatedReceiptEdgeAdd createEmptyInstance() => create();
  static $pb.PbList<ReplicatedReceiptEdgeAdd> createRepeated() =>
      $pb.PbList<ReplicatedReceiptEdgeAdd>();
  @$core.pragma('dart2js:noInline')
  static ReplicatedReceiptEdgeAdd getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ReplicatedReceiptEdgeAdd>(create);
  static ReplicatedReceiptEdgeAdd? _defaultInstance;
  ...
  @$pb.TagNumber(3)
  $pb.PbList<ReplicatedReceiptEdgeAddItem> get items => $_getList(2);
}
...
class VertexCausalBarrier extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  VertexCausalBarrier clone() => VertexCausalBarrier()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<VertexCausalBarrier> createRepeated() =>
      $pb.PbList<VertexCausalBarrier>();
  @$core.pragma('dart2js:noInline')
...
class ReplicatedPutVertex extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$0.Vertex>(1, _omitFieldNames ? '' : 'live',
        subBuilder: $0.Vertex.create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedPutVertex clone() => ReplicatedPutVertex()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ReplicatedPutVertex> createRepeated() =>
      $pb.PbList<ReplicatedPutVertex>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $0.Vertex get live => $_getN(0);
  @$pb.TagNumber(1)
  set live($0.Vertex value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasLive() => $_has(0);
  @$pb.TagNumber(1)
  void clearLive() => $_clearField(1);
  @$pb.TagNumber(1)
  $0.Vertex ensureLive() => $_ensure(0);
...
class ReplicatedPutVertices extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'graph.v1'),
      createEmptyInstance: create)
    ..pc<ReplicatedPutVertex>(
        1, _omitFieldNames ? '' : 'entries', $pb.PbFieldType.PM,
        subBuilder: ReplicatedPutVertex.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedPutVertices clone() =>
      ReplicatedPutVertices()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ReplicatedPutVertices> createRepeated() =>
      $pb.PbList<ReplicatedPutVertices>();
  @$core.pragma('dart2js:noInline')
...
class EdgeCausalBarrier extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  EdgeCausalBarrier clone() => EdgeCausalBarrier()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<EdgeCausalBarrier> createRepeated() =>
      $pb.PbList<EdgeCausalBarrier>();
  @$core.pragma('dart2js:noInline')
...
class ReplicatedPutEdge extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$0.Edge>(1, _omitFieldNames ? '' : 'live', subBuilder: $0.Edge.create)
    ..aOM<EdgeCausalBarrier>(2, _omitFieldNames ? '' : 'causalBarrier',
        subBuilder: EdgeCausalBarrier.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedPutEdge clone() => ReplicatedPutEdge()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ReplicatedPutEdge> createRepeated() =>
      $pb.PbList<ReplicatedPutEdge>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $0.Edge get live => $_getN(0);
  @$pb.TagNumber(1)
  set live($0.Edge value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasLive() => $_has(0);
  @$pb.TagNumber(1)
  void clearLive() => $_clearField(1);
  @$pb.TagNumber(1)
  $0.Edge ensureLive() => $_ensure(0);
...
class ReplicatedPutEdges extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'graph.v1'),
      createEmptyInstance: create)
    ..pc<ReplicatedPutEdge>(
        1, _omitFieldNames ? '' : 'entries', $pb.PbFieldType.PM,
        subBuilder: ReplicatedPutEdge.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReplicatedPutEdges clone() => ReplicatedPutEdges()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ReplicatedPutEdges> createRepeated() =>
      $pb.PbList<ReplicatedPutEdges>();
  @$core.pragma('dart2js:noInline')
...
class Mutation extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  $1.Timestamp get tombstoneExpiration => $_getN(4);
  @$pb.TagNumber(5)
  set tombstoneExpiration($1.Timestamp value) => $_setField(5, value);
  @$pb.TagNumber(5)
...
class SubscribeRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$fixnum.Int64>(
        ...
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..e<SubscribeProjection>(
        3, _omitFieldNames ? '' : 'projection', $pb.PbFieldType.OE,
        defaultOrMaker: SubscribeProjection.SUBSCRIBE_PROJECTION_UNSPECIFIED,
...
class IdentityCheckpoint extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  IdentityCheckpoint clone() => IdentityCheckpoint()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<IdentityCheckpoint> createRepeated() =>
      $pb.PbList<IdentityCheckpoint>();
  @$core.pragma('dart2js:noInline')
...
class IdentityChunk extends $pb.GeneratedMessage {
  factory IdentityChunk({
    ...
    $core.Iterable<$0.EdgeKey>? edgeKeys,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<HLCTimestamp>(3, _omitFieldNames ? '' : 'hlc',
        subBuilder: HLCTimestamp.create)
    ..e<IdentityOperation>(
        4, _omitFieldNames ? '' : 'operation', $pb.PbFieldType.OE,
        defaultOrMaker: IdentityOperation.IDENTITY_OPERATION_UNSPECIFIED,
        valueOf: IdentityOperation.valueOf,
        enumValues: IdentityOperation.values)
    ..a<$core.int>(5, _omitFieldNames ? '' : 'chunkIndex', $pb.PbFieldType.OU3)
    ..aOB(6, _omitFieldNames ? '' : 'isLast')
    ..pPS(7, _omitFieldNames ? '' : 'vertexKeys')
    ..pc<$0.EdgeKey>(8, _omitFieldNames ? '' : 'edgeKeys', $pb.PbFieldType.PM,
        subBuilder: $0.EdgeKey.create)
    ..a<$core.int>(
        9, _omitFieldNames ? '' : 'firstItemIndex', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  IdentityChunk clone() => IdentityChunk()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<IdentityChunk> createRepeated() =>
      $pb.PbList<IdentityChunk>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(8)
  $pb.PbList<$0.EdgeKey> get edgeKeys => $_getList(7);
...
class SnapshotReceiptMetadata extends $pb.GeneratedMessage {
  factory SnapshotReceiptMetadata({
    $0.ReceiptPolicy? activePolicy,
    $fixnum.Int64? clockHighWaterUnixMs,
    $core.Iterable<OriginState>? originCutoffs,
    $core.Iterable<$0.ReceiptPolicy>? retiredPolicies,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'graph.v1'),
      createEmptyInstance: create)
    ..aOM<$0.ReceiptPolicy>(1, _omitFieldNames ? '' : 'activePolicy',
    ...
    ..pc<$0.ReceiptPolicy>(
        4, _omitFieldNames ? '' : 'retiredPolicies', $pb.PbFieldType.PM,
        subBuilder: $0.ReceiptPolicy.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $0.ReceiptPolicy get activePolicy => $_getN(0);
  @$pb.TagNumber(1)
  set activePolicy($0.ReceiptPolicy value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasActivePolicy() => $_has(0);
  @$pb.TagNumber(1)
  void clearActivePolicy() => $_clearField(1);
  @$pb.TagNumber(1)
  $0.ReceiptPolicy ensureActivePolicy() => $_ensure(0);
  ...
  @$pb.TagNumber(4)
  $pb.PbList<$0.ReceiptPolicy> get retiredPolicies => $_getList(3);
}
...
class SnapshotVertexCausalBarrier extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SnapshotVertexCausalBarrier clone() =>
      SnapshotVertexCausalBarrier()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<SnapshotVertexCausalBarrier> createRepeated() =>
      $pb.PbList<SnapshotVertexCausalBarrier>();
  @$core.pragma('dart2js:noInline')
...
class SnapshotEdgeCausalBarrier extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SnapshotEdgeCausalBarrier clone() =>
      SnapshotEdgeCausalBarrier()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<SnapshotEdgeCausalBarrier> createRepeated() =>
      $pb.PbList<SnapshotEdgeCausalBarrier>();
  @$core.pragma('dart2js:noInline')
...
class SnapshotVertexTombstone extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<HLCTimestamp>(2, _omitFieldNames ? '' : 'hlc',
        subBuilder: HLCTimestamp.create)
    ..aOM<$1.Timestamp>(3, _omitFieldNames ? '' : 'expiration',
        subBuilder: $1.Timestamp.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SnapshotVertexTombstone clone() =>
      SnapshotVertexTombstone()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<SnapshotVertexTombstone> createRepeated() =>
      $pb.PbList<SnapshotVertexTombstone>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  $1.Timestamp get expiration => $_getN(2);
  @$pb.TagNumber(3)
  set expiration($1.Timestamp value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasExpiration() => $_has(2);
  @$pb.TagNumber(3)
  void clearExpiration() => $_clearField(3);
  @$pb.TagNumber(3)
  $1.Timestamp ensureExpiration() => $_ensure(2);
}
...
class SnapshotEdgeTombstone extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SnapshotEdgeTombstone clone() =>
      SnapshotEdgeTombstone()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<SnapshotEdgeTombstone> createRepeated() =>
      $pb.PbList<SnapshotEdgeTombstone>();
  @$core.pragma('dart2js:noInline')
