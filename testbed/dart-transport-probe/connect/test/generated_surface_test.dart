...
import 'package:lantern_connect_transport_probe/src/gen/google/protobuf/duration.pb.dart'
    as wkt_duration;
import 'package:lantern_connect_transport_probe/src/gen/google/protobuf/timestamp.pb.dart'
    as wkt_timestamp;
...
void main() {
  ...
  test('Connect cancellation primitives compile and cancel', () {
    final timeout = TimeoutSignal(const Duration(seconds: 1));
    final cancelable = CancelableSignal();
    expect(timeout, isNotNull);
    expect(cancelable, isNotNull);
    cancelable.cancel();
  });
}
