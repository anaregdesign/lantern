...
func TestPeriodicBackupReportShowsNamedMatchedWindows(t *testing.T) {
	...
	for _, want := range []string{"## Periodic backup/read correlation", "1/1 periodic attempts completed", "Result: `fired`", "`42`", "300.00 | 600.00 | 100.00", "`GetVertex` | 1.00 / 100 / 0.000 | 3.00 / 120 / 0.000 | 2.00 / 110 / 0.000 | true"} {
