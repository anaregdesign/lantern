...
const $core.Map<$core.String, $core.dynamic> LanternServiceBase$json = {
  '1': 'LanternService',
  '2': [
    {
      '1': 'Illuminate',
      '2': '.graph.v1.IlluminateRequest',
      '3': '.graph.v1.IlluminateResponse'
    },
    {
      '1': 'GetVertex',
      '2': '.graph.v1.GetVertexRequest',
      '3': '.graph.v1.GetVertexResponse'
    },
    {
      '1': 'GetVertices',
      '2': '.graph.v1.GetVerticesRequest',
      '3': '.graph.v1.GetVerticesResponse'
    },
    {
      '1': 'PutVertex',
      '2': '.graph.v1.PutVertexRequest',
      '3': '.graph.v1.PutVertexResponse'
    },
    {
      '1': 'PutVertices',
      '2': '.graph.v1.PutVerticesRequest',
      '3': '.graph.v1.PutVerticesResponse'
    },
    {
      '1': 'DeleteVertex',
      '2': '.graph.v1.DeleteVertexRequest',
      '3': '.graph.v1.DeleteVertexResponse'
    },
    {
      '1': 'DeleteVertices',
      '2': '.graph.v1.DeleteVerticesRequest',
      '3': '.graph.v1.DeleteVerticesResponse'
    },
    {
      '1': 'ScanVertices',
      '2': '.graph.v1.ScanVerticesRequest',
      '3': '.graph.v1.ScanVerticesResponse'
    },
    {
      '1': 'ScanVertexKeys',
      '2': '.graph.v1.ScanVertexKeysRequest',
      '3': '.graph.v1.ScanVertexKeysResponse'
    },
    {
      '1': 'SearchVertices',
      '2': '.graph.v1.SearchVerticesRequest',
      '3': '.graph.v1.SearchVerticesResponse'
    },
    {
      '1': 'CountVerticesByPrefix',
      '2': '.graph.v1.CountVerticesByPrefixRequest',
      '3': '.graph.v1.CountVerticesByPrefixResponse'
    },
    {
      '1': 'DeleteVerticesByPrefix',
      '2': '.graph.v1.DeleteVerticesByPrefixRequest',
      '3': '.graph.v1.DeleteVerticesByPrefixResponse'
    },
    {
      '1': 'TopVerticesByDegree',
      '2': '.graph.v1.TopVerticesByDegreeRequest',
      '3': '.graph.v1.TopVerticesByDegreeResponse'
    },
    {
      '1': 'GetEdge',
      '2': '.graph.v1.GetEdgeRequest',
      '3': '.graph.v1.GetEdgeResponse'
    },
    {
      '1': 'GetEdges',
      '2': '.graph.v1.GetEdgesRequest',
      '3': '.graph.v1.GetEdgesResponse'
    },
    {
      '1': 'AddEdge',
      '2': '.graph.v1.AddEdgeRequest',
      '3': '.graph.v1.AddEdgeResponse'
    },
    {
      '1': 'AddEdges',
      '2': '.graph.v1.AddEdgesRequest',
    ...
    {
      '1': 'PutEdges',
      '2': '.graph.v1.PutEdgesRequest',
      '3': '.graph.v1.PutEdgesResponse'
    },
    {
      '1': 'DeleteEdge',
      '2': '.graph.v1.DeleteEdgeRequest',
      '3': '.graph.v1.DeleteEdgeResponse'
    },
    {
      '1': 'DeleteEdges',
      '2': '.graph.v1.DeleteEdgesRequest',
    ...
    {
      '1': 'ScanEdges',
      '2': '.graph.v1.ScanEdgesRequest',
      '3': '.graph.v1.ScanEdgesResponse'
    },
    {
      '1': 'GetServerStatus',
      '2': '.graph.v1.GetServerStatusRequest',
      '3': '.graph.v1.GetServerStatusResponse'
    },
    {
      '1': 'GetReplicationStatus',
      '2': '.graph.v1.GetReplicationStatusRequest',
      '3': '.graph.v1.GetReplicationStatusResponse'
    },
    {
      '1': 'GetReceiptCapability',
      '2': '.graph.v1.GetReceiptCapabilityRequest',
      '3': '.graph.v1.GetReceiptCapabilityResponse'
    },
    {
      '1': 'GetReceiptStatus',
      '2': '.graph.v1.GetReceiptStatusRequest',
      '3': '.graph.v1.GetReceiptStatusResponse'
    },
    {
      '1': 'GetReceiptStatuses',
      '2': '.graph.v1.GetReceiptStatusesRequest',
      '3': '.graph.v1.GetReceiptStatusesResponse'
    },
    {
      '1': 'BackupSnapshot',
      '2': '.graph.v1.BackupSnapshotRequest',
      '3': '.graph.v1.BackupSnapshotResponse',
      '6': true
    },
  ],
};

@$core.Deprecated('Use lanternServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    LanternServiceBase$messageJson = {
  '.graph.v1.IlluminateRequest': IlluminateRequest$json,
  '.graph.v1.BfsParams': BfsParams$json,
  '.graph.v1.PprParams': PprParams$json,
  '.graph.v1.LocalCommunityParams': LocalCommunityParams$json,
  '.graph.v1.IlluminateResponse': IlluminateResponse$json,
  '.graph.v1.Graph': Graph$json,
  '.graph.v1.Vertex': Vertex$json,
  '.google.protobuf.Timestamp': $0.Timestamp$json,
  '.google.protobuf.Duration': $1.Duration$json,
  '.graph.v1.Edge': Edge$json,
  '.graph.v1.GetVertexRequest': GetVertexRequest$json,
  '.graph.v1.GetVertexResponse': GetVertexResponse$json,
  '.graph.v1.GetVerticesRequest': GetVerticesRequest$json,
  '.graph.v1.GetVerticesResponse': GetVerticesResponse$json,
  '.graph.v1.PutVertexRequest': PutVertexRequest$json,
  '.graph.v1.PutVertexResponse': PutVertexResponse$json,
  '.graph.v1.PutVerticesRequest': PutVerticesRequest$json,
  '.graph.v1.PutVerticesResponse': PutVerticesResponse$json,
  '.graph.v1.DeleteVertexRequest': DeleteVertexRequest$json,
  '.graph.v1.DeleteVertexResponse': DeleteVertexResponse$json,
  '.graph.v1.DeleteVerticesRequest': DeleteVerticesRequest$json,
  '.graph.v1.DeleteVerticesResponse': DeleteVerticesResponse$json,
  '.graph.v1.ScanVerticesRequest': ScanVerticesRequest$json,
  '.graph.v1.ScanVerticesResponse': ScanVerticesResponse$json,
  '.graph.v1.ScanVertexKeysRequest': ScanVertexKeysRequest$json,
  '.graph.v1.ScanVertexKeysResponse': ScanVertexKeysResponse$json,
  '.graph.v1.SearchVerticesRequest': SearchVerticesRequest$json,
  '.graph.v1.SearchOptions': SearchOptions$json,
  '.graph.v1.SearchVerticesResponse': SearchVerticesResponse$json,
  '.graph.v1.SearchHit': SearchHit$json,
  '.graph.v1.CountVerticesByPrefixRequest': CountVerticesByPrefixRequest$json,
  '.graph.v1.CountVerticesByPrefixResponse': CountVerticesByPrefixResponse$json,
  '.graph.v1.DeleteVerticesByPrefixRequest': DeleteVerticesByPrefixRequest$json,
  '.graph.v1.DeleteVerticesByPrefixResponse':
      DeleteVerticesByPrefixResponse$json,
  '.graph.v1.TopVerticesByDegreeRequest': TopVerticesByDegreeRequest$json,
  '.graph.v1.TopVerticesByDegreeResponse': TopVerticesByDegreeResponse$json,
  '.graph.v1.TopVerticesByDegreeResponse.Entry':
      TopVerticesByDegreeResponse_Entry$json,
  '.graph.v1.GetEdgeRequest': GetEdgeRequest$json,
  '.graph.v1.GetEdgeResponse': GetEdgeResponse$json,
  '.graph.v1.GetEdgesRequest': GetEdgesRequest$json,
  '.graph.v1.EdgeKey': EdgeKey$json,
  ...
  '.graph.v1.PutEdgesResponse': PutEdgesResponse$json,
  '.graph.v1.DeleteEdgeRequest': DeleteEdgeRequest$json,
  '.graph.v1.MutationReceiptContext': MutationReceiptContext$json,
  '.graph.v1.ReceiptEndpoint': ReceiptEndpoint$json,
  ...
  '.graph.v1.ScanEdgesResponse': ScanEdgesResponse$json,
  ...
  '.graph.v1.CausalMetadataStatus': CausalMetadataStatus$json,
  '.graph.v1.CausalMetadataKindStatus': CausalMetadataKindStatus$json,
  ...
  '.graph.v1.GetReceiptCapabilityRequest': GetReceiptCapabilityRequest$json,
  '.graph.v1.GetReceiptCapabilityResponse': GetReceiptCapabilityResponse$json,
  '.graph.v1.ReceiptPolicy': ReceiptPolicy$json,
  '.graph.v1.GetReceiptStatusRequest': GetReceiptStatusRequest$json,
  '.graph.v1.GetReceiptStatusResponse': GetReceiptStatusResponse$json,
  '.graph.v1.ReceiptStatus': ReceiptStatus$json,
  '.graph.v1.MutationReceipt': MutationReceipt$json,
  '.graph.v1.ReceiptResult': ReceiptResult$json,
  '.graph.v1.GetReceiptStatusesRequest': GetReceiptStatusesRequest$json,
  '.graph.v1.GetReceiptStatusesResponse': GetReceiptStatusesResponse$json,
  '.graph.v1.BackupSnapshotRequest': BackupSnapshotRequest$json,
  '.graph.v1.BackupSnapshotResponse': BackupSnapshotResponse$json,
};

/// Descriptor for `LanternService`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List lanternServiceDescriptor = $convert.base64Decode(
    'Cg5MYW50ZXJuU2VydmljZRJHCgpJbGx1bWluYXRlEhsuZ3JhcGgudjEuSWxsdW1pbmF0ZVJlcX'
    'Vlc3QaHC5ncmFwaC52MS5JbGx1bWluYXRlUmVzcG9uc2USRAoJR2V0VmVydGV4EhouZ3JhcGgu'
    'djEuR2V0VmVydGV4UmVxdWVzdBobLmdyYXBoLnYxLkdldFZlcnRleFJlc3BvbnNlEkoKC0dldF'
    'ZlcnRpY2VzEhwuZ3JhcGgudjEuR2V0VmVydGljZXNSZXF1ZXN0Gh0uZ3JhcGgudjEuR2V0VmVy'
    'dGljZXNSZXNwb25zZRJECglQdXRWZXJ0ZXgSGi5ncmFwaC52MS5QdXRWZXJ0ZXhSZXF1ZXN0Gh'
    'suZ3JhcGgudjEuUHV0VmVydGV4UmVzcG9uc2USSgoLUHV0VmVydGljZXMSHC5ncmFwaC52MS5Q'
    'dXRWZXJ0aWNlc1JlcXVlc3QaHS5ncmFwaC52MS5QdXRWZXJ0aWNlc1Jlc3BvbnNlEk0KDERlbG'
    'V0ZVZlcnRleBIdLmdyYXBoLnYxLkRlbGV0ZVZlcnRleFJlcXVlc3QaHi5ncmFwaC52MS5EZWxl'
    'dGVWZXJ0ZXhSZXNwb25zZRJTCg5EZWxldGVWZXJ0aWNlcxIfLmdyYXBoLnYxLkRlbGV0ZVZlcn'
    'RpY2VzUmVxdWVzdBogLmdyYXBoLnYxLkRlbGV0ZVZlcnRpY2VzUmVzcG9uc2USTQoMU2NhblZl'
    'cnRpY2VzEh0uZ3JhcGgudjEuU2NhblZlcnRpY2VzUmVxdWVzdBoeLmdyYXBoLnYxLlNjYW5WZX'
    'J0aWNlc1Jlc3BvbnNlElMKDlNjYW5WZXJ0ZXhLZXlzEh8uZ3JhcGgudjEuU2NhblZlcnRleEtl'
    'eXNSZXF1ZXN0GiAuZ3JhcGgudjEuU2NhblZlcnRleEtleXNSZXNwb25zZRJTCg5TZWFyY2hWZX'
    'J0aWNlcxIfLmdyYXBoLnYxLlNlYXJjaFZlcnRpY2VzUmVxdWVzdBogLmdyYXBoLnYxLlNlYXJj'
    'aFZlcnRpY2VzUmVzcG9uc2USaAoVQ291bnRWZXJ0aWNlc0J5UHJlZml4EiYuZ3JhcGgudjEuQ2'
    '91bnRWZXJ0aWNlc0J5UHJlZml4UmVxdWVzdBonLmdyYXBoLnYxLkNvdW50VmVydGljZXNCeVBy'
    'ZWZpeFJlc3BvbnNlEmsKFkRlbGV0ZVZlcnRpY2VzQnlQcmVmaXgSJy5ncmFwaC52MS5EZWxldG'
    'VWZXJ0aWNlc0J5UHJlZml4UmVxdWVzdBooLmdyYXBoLnYxLkRlbGV0ZVZlcnRpY2VzQnlQcmVm'
    'aXhSZXNwb25zZRJiChNUb3BWZXJ0aWNlc0J5RGVncmVlEiQuZ3JhcGgudjEuVG9wVmVydGljZX'
    'NCeURlZ3JlZVJlcXVlc3QaJS5ncmFwaC52MS5Ub3BWZXJ0aWNlc0J5RGVncmVlUmVzcG9uc2US'
    'PgoHR2V0RWRnZRIYLmdyYXBoLnYxLkdldEVkZ2VSZXF1ZXN0GhkuZ3JhcGgudjEuR2V0RWRnZV'
