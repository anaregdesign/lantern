 ...
 *
 * @generated from message graph.v1.SnapshotEdgeDerivedAggregate
 */
export type SnapshotEdgeDerivedAggregate = Message<"graph.v1.SnapshotEdgeDerivedAggregate"> & {
  /**
   * @generated from field: float weight = 1;
   */
  weight: number;
  ...
  /**
   * @generated from field: repeated graph.v1.SnapshotEdgeContribution adds = 3;
   */
  adds: SnapshotEdgeContribution[];
};

/**
 * Describes the message graph.v1.SnapshotEdgeDerivedAggregate.
...
export type SnapshotEdge = Message<"graph.v1.SnapshotEdge"> & {
   ...
   *
   * @generated from field: graph.v1.SnapshotEdgeDerivedAggregate derived_aggregate = 5;
   */
  derivedAggregate?: SnapshotEdgeDerivedAggregate | undefined;
};
