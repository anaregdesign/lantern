...
function createBaseBatchingSettingsProto(): BatchingSettingsProto {
  return {
    ...
    requestByteThreshold: Long.ZERO,
...
export const BatchingSettingsProto: MessageFns<BatchingSettingsProto> = {
  encode(message: BatchingSettingsProto, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (!message.requestByteThreshold.equals(Long.ZERO)) {
      writer.uint32(16).int64(message.requestByteThreshold.toString());
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.requestByteThreshold = Long.fromString(reader.int64().toString());
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): BatchingSettingsProto {
    return {
      ...
      requestByteThreshold: isSet(object.requestByteThreshold)
        ? Long.fromValue(object.requestByteThreshold)
        : Long.ZERO,
  ...
  toJSON(message: BatchingSettingsProto): unknown {
    ...
    if (!message.requestByteThreshold.equals(Long.ZERO)) {
      obj.requestByteThreshold = (message.requestByteThreshold || Long.ZERO).toString();
    }
    if (message.delayThreshold !== undefined) {
  ...
  fromPartial(object: DeepPartial<BatchingSettingsProto>): BatchingSettingsProto {
    ...
    message.requestByteThreshold = (object.requestByteThreshold !== undefined && object.requestByteThreshold !== null)
      ? Long.fromValue(object.requestByteThreshold)
      : Long.ZERO;
