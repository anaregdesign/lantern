...
export const OperationsService = {
  ...
  getOperation: {
    ...
    responseSerialize: (value: Operation): Buffer => Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer): Operation => Operation.decode(value),
  },
  /**
  ...
  deleteOperation: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteOperationRequest): Buffer =>
      Buffer.from(DeleteOperationRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): DeleteOperationRequest => DeleteOperationRequest.decode(value),
  ...
  cancelOperation: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CancelOperationRequest): Buffer =>
      Buffer.from(CancelOperationRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): CancelOperationRequest => CancelOperationRequest.decode(value),
    responseSerialize: (value: Empty): Buffer => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer): Empty => Empty.decode(value),
  },
  /**
  ...
  waitOperation: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: WaitOperationRequest): Buffer => Buffer.from(WaitOperationRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): WaitOperationRequest => WaitOperationRequest.decode(value),
    responseSerialize: (value: Operation): Buffer => Buffer.from(Operation.encode(value).finish()),
    responseDeserialize: (value: Buffer): Operation => Operation.decode(value),
  },
} as const;

export interface OperationsServer extends UntypedServiceImplementation {
  /**
   * Lists operations that match the specified filter in the request. If the
   * server doesn't support this method, it returns `UNIMPLEMENTED`.
   */
   ...
   * service.
   */
  getOperation: handleUnaryCall<GetOperationRequest, Operation>;
  /**
   * Deletes a long-running operation. This method indicates that the client is
   * no longer interested in the operation result. It does not cancel the
   * operation. If the server doesn't support this method, it returns
   * `google.rpc.Code.UNIMPLEMENTED`.
   */
  deleteOperation: handleUnaryCall<DeleteOperationRequest, Empty>;
  /**
   * Starts asynchronous cancellation on a long-running operation.  The server
   * makes a best effort to cancel the operation, but success is not
   * guaranteed.  If the server doesn't support this method, it returns
   ...
   * `Code.CANCELLED`.
   */
  cancelOperation: handleUnaryCall<CancelOperationRequest, Empty>;
  /**
   * Waits until the specified long-running operation is done or reaches at most
   * a specified timeout, returning the latest state.  If the operation is
   * already done, the latest state is immediately returned.  If the timeout
   ...
   * immediate response is no guarantee that the operation is done.
   */
  waitOperation: handleUnaryCall<WaitOperationRequest, Operation>;
}

export interface OperationsClient extends Client {
  /**
   * Lists operations that match the specified filter in the request. If the
   * server doesn't support this method, it returns `UNIMPLEMENTED`.
   */
...
export const OperationsClient = makeGenericClientConstructor(
  OperationsService,
  "google.longrunning.Operations",
) as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): OperationsClient;
  service: typeof OperationsService;
  serviceName: string;
};
