...
// replaces its postings, so Index doubles as update. Index returns a typed
// AnalysisLimitError when configured document or aggregate budgets reject the
// final state. How text is analyzed and
